package com.sidney.multiitem.adapter;
...
import com.sidney.multiitem.adapter.holder.HeadFootHolderManager;
import com.sidney.multiitem.adapter.holder.ViewHolderManager;
import com.sidney.multiitem.adapter.holder.ViewHolderManagerGroup;
import com.sidney.multiitem.adapter.holder.ViewHolderParams;
import com.sidney.multiitem.adapter.type.ItemTypeManager;
import com.sidney.multiitem.animation.AnimationLoader;
import com.sidney.multiitem.animation.BaseAnimation;
import com.sidney.multiitem.common.MultiItemConstant;
import com.sidney.multiitem.item.LoadMoreManager;
import com.sidney.multiitem.item.UniqueItemManager;
...
public class BaseItemAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public void onBindViewHolder(BaseViewHolder holder, int position, List<Object> payloads) {
        if (payloads.isEmpty()) {
            ...
            manager.onBindViewHolder(holder, item, params, payloads);
            //赋值 方便以后使用
            holder.itemView.setTag(MultiItemConstant.VIEW_HOLDER_TAG, holder);
