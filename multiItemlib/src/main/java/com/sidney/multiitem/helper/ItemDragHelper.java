...
import com.sidney.multiitem.listener.OnItemDragListener;


/**
 * 描 述：  面板拖动辅助类 -跨RecyclerView拖动
 ...
 * 作 者：hxl  2022/1/28 15:24
 * 修改描述：
 * 修 改 人：xxx  2022/1/28 15:24
 * 修改版本：
 */
...
//        System.out.println("getInsideLocation:" + result[0] + "-" + result[1] + "==" + "X:" + touchRawX + "Y:" + touchRawY);
     ...
     */
    private int calcItemPositionWhenChangeRecycler(RecyclerView verticalRecycler, View itemView,
                                                   int itemPos, float childX, float childY) {
